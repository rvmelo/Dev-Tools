            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new appError_1.default(' wrong user/password combinations');
                        }
                    ...
                    case 2:
                        ...
                        if (!passwordMatched) {
                            throw new appError_1.default(' wrong user/password combination');
                        }
                        return [2 /*return*/, { user: class_transformer_1.classToClass(user), token: token }];
                }
            });
        });
    };
