...
var searchToolsService_1 = __importDefault(require("./searchToolsService"));
describe('SearchToolsService', function () {
    ...
    it('should find given tool', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createToolService, searchToolsService, tools;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, searchToolsService.execute({ tag: 'github' })];
                case 3:
                    tools = _a.sent();
