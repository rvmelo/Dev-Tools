...
describe('ListToolService', function () {
    ...
    it('should list all tools', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createToolService, listToolService, tools;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    createToolService = new createToolService_1.default();
                    listToolService = new listToolsService_1.default();
