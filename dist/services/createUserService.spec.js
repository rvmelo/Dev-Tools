...
describe('AuthenticateUserService', function () {
    ...
    it('should create new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, expect(user).toMatchObject({
                            email: 'yennefer@gmail.com',
                        })];
                case 2:
                    _a.sent();
    ...
    it('should not create user with email that already exists', function () { return __awaiter(void 0, void 0, void 0, function () {
